...
import { Heading, HStack, SkeletonCircle, SkeletonText, Stack } from '@chakra-ui/react';
...
export const MembersList = () => {
  ...
  const currentMembersCount = members.filter((member) => member.role !== WorkspaceRole.GUEST).length + invitations.length;
