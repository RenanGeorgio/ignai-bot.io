...
import { Button, HTMLChakraProps, Input, Stack, HStack, Text, Spinner, Alert, Flex, AlertIcon, SlideFade } from '@chakra-ui/react';
...
export const SignInForm = ({ defaultEmail }: Props & HTMLChakraProps<'form'>) => {
  ...
  useEffect(() => {
    ...
    if (router.query.error === 'ip-banned') {
      showToast({
        status: 'info',
        description: 'Your account has suspicious activity and is being reviewed by our team. Feel free to contact us.',
      });
    }
