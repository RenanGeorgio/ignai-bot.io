...
export const IgaiIcon = (props: IconProps) => (
  <Icon viewBox="0 0 1024 1024" fill="currentColor" {...props}>
    <title>IgnaiIcon</title>
    <path
      d="M 109.5,-0.5 C 120.833,-0.5 132.167,-0.5 143.5,-0.5C 153.095,1.53243 162.429,4.69909 171.5,9C 196.078,24.7928 221.745,38.7928 248.5,51C 281.28,64.1528 315.113,73.3194 350,78.5C 435.891,87.9044 513.724,67.4044 583.5,17C 630.812,-7.20322 676.145,-3.86988 719.5,27C 726.996,33.061 733.996,39.561 740.5,46.5C 745.92,53.245 750.92,60.245 755.5,67.5C 780.215,116.062 779.048,164.062 752,211.5C 744.062,223.268 734.895,233.935 724.5,243.5C 684.07,275.513 640.07,281.347 592.5,261C 574.5,250 556.5,239 538.5,228C 513.442,215.536 487.109,206.87 459.5,202C 393.742,188.607 329.076,192.607 265.5,214C 252.808,218.845 240.475,224.512 228.5,231C 211.199,240.986 193.865,250.986 176.5,261C 119.039,283.884 70.0392,272.051 29.5,225.5C 21.3997,214.309 14.5664,202.309 9,189.5C 5.01855,177.237 1.85188,164.904 -0.5,152.5C -0.5,141.833 -0.5,131.167 -0.5,120.5C 6.04936,73.2028 29.716,37.3694 70.5,13C 83.0283,6.76976 96.0283,2.26976 109.5,-0.5 Z"
      fill="#fc6259"
    />
  </Icon>
)