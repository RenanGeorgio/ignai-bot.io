...
type CustomHTMLDivElement = Omit<
  HTMLDivElement,
...
type CustomElement = FocusableElement | HTMLButtonElement | HTMLDivElement
        ...
        >
          ...
          >
            <SidebarContent
              tab={title}
              navSize={navSize}
              color={active ? 'rgba(255, 0, 0, 0.9)' : 'gray.500'}
            />
          </MenuButton>
        </Link>
        {/* <MenuList
...
const CustomSideBar = () => {
  ...
  return (
    ...
    >
      <VStack w="100%" alignItems="center" spacing={0}>
        <IconButton
          background="none"
          aria-label="Colapse"
          mt={5}
        ...
        <Flex flexDir="column" w="100%" alignItems="flex-start" as="nav">
          <Tooltip hasArrow label="Dashboard">
            <NavItem
              ...
              navSize={navSize}
              title="Dashboard"
              description="Dashboard - Pagina de entrada."
            />
          </Tooltip>
          <Tooltip hasArrow label="Home">
            <NavItem
              ...
              navSize={navSize}
              title="Home"
              description="Pagina inicial da aplicação."
            />
          </Tooltip>
          ...
          <Tooltip hasArrow label="Channels">
            <NavItem
              ...
              navSize={navSize}
              title="Channels"
              description="Canais de comunicação no Workspace"
            />
          </Tooltip>
          <Tooltip hasArrow label="Emails">
            <NavItem
              ...
              navSize={navSize}
              title="Emails"
              description="Lista dos emails enviados"
            />
          </Tooltip>
          <Tooltip hasArrow label="Email Builder">
            <NavItem
              router={router}
              path={'/email-builder'}
              navSize={navSize}
              title="Email Builder"
              description="Construtor de Email"
            />
          </Tooltip>
        </Flex>
      </VStack>
